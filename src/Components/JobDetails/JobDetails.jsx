         ...
         <div className="py-10">
            <div className="flex gap-4">
               <div className="w-3/4 space-y-4">
                  <p className="text-[#757575] font-normal"><span className="text-[#1A1919] font-bold">Job Description: </span>{job_description}</p>
                  <p className="text-[#757575] font-normal"><span className="text-[#1A1919] font-bold">Job Responsibility: </span>{job_responsibility}</p>
                  <p className="text-[#757575] font-normal"><span className="text-[#1A1919] font-bold">Educational Requirements: </span>{educational_requirements}</p>
                  <p className="text-[#757575] font-normal"><span className="text-[#1A1919] font-bold">Experiences: </span>{experiences}</p>
               </div>
               <div className="w-1/4">
                  <div className="bg-[#F2F4FF] p-6 rounded-md">
                     <h3 className="text-[#1A1919] font-semibold text-lg">Job Details</h3>
                     ...
                     <div className="space-y-3">
                        <div className="flex gap-2 items-center">
                           ...
                           <p className="text-[#757575]"><span className="text-[#474747] font-medium">Salary:</span> {salary} (Per Year)</p>
                        </div>
                        <div className="flex gap-2 items-center">
                           <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                           ...
                           <p className="text-[#757575]"><span className="text-[#474747] font-medium">Job Title:</span> {job_title}</p>
                        </div>
                     </div>
                     <h3 className="text-[#1A1919] font-semibold text-lg my-3">Contact Information</h3>
                     <hr className="my-4 h-0.5 bg-gray-200" />
                     <div className="space-y-3">
                        <div className="flex gap-2 items-center">
                           <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                           ...
                           <p className="text-[#757575]"><span className="text-[#474747] font-medium">Phone:</span> {contact_information.phone}</p>
                        </div>
                        <div className="flex gap-2 items-center">
                           <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                           ...
                           <p className="text-[#757575]"><span className="text-[#474747] font-medium">Email:</span> {contact_information.email}</p>
                        </div>
                        <div className="flex gap-2 content-start">
                           ...
                           <p className="text-[#757575]"><span className="text-[#474747] font-medium">Address:</span> {contact_information.address}</p>
                        </div>
                     </div>                     
                  </div>
                  <button onClick={toastText} className='mt-4 bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white py-2 px-4 font-medium rounded-md w-full'>Apply Now</button>
